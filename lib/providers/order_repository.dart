...
class OrderRepository {
  ...
  Future<Map<String, dynamic>> createOrder(
    ...
    try {
      ...
      final res = await ApiClient.dio.post('/create-order', data: orderData);
      ...
      return {'success': false, 'message': 'حدث خطأ أثناء إنشاء الطلب: $e'};
    }
  }
  ...
  Future<Map<String, dynamic>> getClientOrdersLegacy() async {
    try {
      ...
      return {'success': false, 'message': 'حدث خطأ أثناء جلب الطلبات: $e'};
    }
  }
  ...
  Future<Map<String, dynamic>> cancelOrder(int orderId) async {
    try {
      ...
      return {'success': false, 'message': 'حدث خطأ أثناء إلغاء الطلب: $e'};
    }
  }
