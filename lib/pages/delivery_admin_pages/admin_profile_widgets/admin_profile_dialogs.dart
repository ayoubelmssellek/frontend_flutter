...
class AdminProfileDialogs {
        ...
        onSave: (name, avatar) async {
          if (name.isEmpty) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('admin_profile_page.name_required'.tr())),
            );
            return false;
          }
          ...
          try {
            ...
            if (result['success'] == true) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(result['message'] ?? 'admin_profile_page.profile_updated'.tr()),
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(result['message'] ?? 'admin_profile_page.update_failed'.tr()),
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('admin_profile_page.update_error'.tr() + ': $e'),
                backgroundColor: Colors.red,
              ),
            );
            return false;
  ...
  static void showLanguageDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('admin_profile_page.language'.tr()),
        content: Text('admin_profile_page.change_app_language'.tr()),
        actions: [
  ...
  static void showContactSupport(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('admin_profile_page.contact_support'.tr()),
        content: Text('${'admin_profile_page.customer_support'.tr()}\nEmail: admin-support@foodapp.com\nPhone: +212 522 123 456'),
        actions: [
          TextButton(
  ...
  static void showFeedback(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('admin_profile_page.send_feedback'.tr()),
        content: TextField(
          decoration: InputDecoration(
            hintText: 'admin_profile_page.feedback_hint'.tr(),
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              Navigator.pop(context);
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('admin_profile_page.feedback_sent'.tr())),
              );
            },
            child: Text('admin_profile_page.send'.tr()),
          ),
        ],
      ),
    );
  ...
  static void showPrivacyPolicy(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('admin_profile_page.privacy_policy'.tr()),
        content: SingleChildScrollView(
          child: Text('admin_profile_page.privacy_policy_content'.tr()),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
...
class _UpdateProfileDialogState extends State<_UpdateProfileDialog> {
  ...
  Future<void> _pickImage() async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('admin_profile_page.image_pick_error'.tr())),
        );
      }
    }
  }
  ...
  Future<void> _takePhoto() async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('admin_profile_page.camera_error'.tr())),
        );
      }
    }
  }
  ...
  void _showImageSourceDialog() {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('admin_profile_page.choose_image_source'.tr()),
        actions: [
          TextButton(
            onPressed: () {
              Navigator.pop(context);
            ...
            child: Text('admin_profile_page.gallery'.tr()),
          ),
          TextButton(
            onPressed: () {
              Navigator.pop(context);
            ...
            child: Text('admin_profile_page.camera'.tr()),
          ),
        ],
      ),
    );
      ...
      child: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text(
                'admin_profile_page.update_profile'.tr(),
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    Text(
                      'admin_profile_page.avatar_optional'.tr(),
                      style: TextStyle(
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'admin_profile_page.name'.tr(),
                  border: const OutlineInputBorder(),
                  prefixIcon: const Icon(Icons.person),
                ),
                validator: (value) {
                  if (value == null || value.trim().isEmpty) {
                    return 'admin_profile_page.name_required'.tr();
                  }
                  return null;
                },
              ),
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                '${'admin_profile_page.current'.tr()}: ${widget.currentPhone}',
                style: TextStyle(
                  color: Colors.grey.shade600,
                ),
              ),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'admin_profile_page.new_phone'.tr(),
                  border: const OutlineInputBorder(),
                  prefixIcon: const Icon(Icons.phone),
                ),
                validator: (value) {
                  if (value == null || value.trim().isEmpty) {
                    return 'admin_profile_page.phone_required'.tr();
                  }
                  if (value.length < 10) {
                    return 'admin_profile_page.phone_valid'.tr();
                  }
                  return null;
                },
              ),
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: _isLoading
                          ...
                          : Text('admin_profile_page.send_code'.tr()),
                    ),
                  ),
                ],
              ),
