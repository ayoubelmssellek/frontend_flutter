      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              // Print current statistics and user info
              ref.read(deliveryManStatsProvider.future).then((stats) {
                _printStatistics(stats);
              });
              ref.read(currentUserProvider.future).then((userData) {
