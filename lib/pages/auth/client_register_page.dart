...
class _RegisterPageState extends ConsumerState<RegisterPage>
  ...
  Future<void> _getFcmToken() async {
    try {
      ...
      if (_fcmToken != null && kDebugMode) {
        print("🔑 RegisterPage FCM Token: $_fcmToken");
      }
    } catch (e) {
      if (kDebugMode) {
        print("❌ Error getting FCM token in RegisterPage: $e");
      }
    }
  }
  ...
  Future<void> _clearOldUserData() async {
    try {
      ...
      if (kDebugMode) {
        print('🗑️ Old user data cleared before register');
      }
    } catch (e) {
      if (kDebugMode) {
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      final result = await ref.read(registerProvider(creds).future);
